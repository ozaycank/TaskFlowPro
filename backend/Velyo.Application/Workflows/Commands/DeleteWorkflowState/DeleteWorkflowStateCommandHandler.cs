...
public class DeleteWorkflowStateCommandHandler : IRequestHandler<DeleteWorkflowStateCommand>
{
    private readonly IWorkflowRepository _workflowRepository;
    private readonly IWorkspaceAuthorizationService _authorizationService;
    private readonly IUnitOfWork _unitOfWork;

    public DeleteWorkflowStateCommandHandler(
    ...
    public async Task Handle(DeleteWorkflowStateCommand request, CancellationToken cancellationToken)
    {
        ...
        workflow.RemoveState(request.StateId);
